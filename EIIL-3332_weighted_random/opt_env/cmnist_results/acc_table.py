...
def main(flags):
  ...
  results = dict( ### eiil_cb, cb 삭제
    ...
    eiil_infer =load_results(flags.eiil_infer_results_dir)
  )
  """
...
if __name__ == '__main__':
  ...
  parser.add_argument('--eiil_infer_results_dir', type=str, default='/scratch/gobi1/creager/opt_env/cmnist/eiil_infer')
  #parser.add_argument('--eiil_cb_results_dir', type=str, default='/scratch/gobi1/creager/opt_env/cmnist/eiil_cb') ### 제거
  #parser.add_argument('--cb_results_dir', type=str, default='/scratch/gobi1/creager/opt_env/cmnist/cb') ### 제거
