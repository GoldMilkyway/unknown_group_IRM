...
if __name__ == '__main__':
  ...
  parser.add_argument('--train_env_1__color_noise', type=float, default=0.2) ### 수정 0.2 -> 0.1 ###
  parser.add_argument('--train_env_2__color_noise', type=float, default=0.25) ### 수정 0.1 -> 0.2###
